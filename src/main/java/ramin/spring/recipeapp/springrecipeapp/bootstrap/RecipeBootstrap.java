package ramin.spring.recipeapp.springrecipeapp.bootstrap;

import lombok.extern.slf4j.Slf4j;
import ramin.spring.recipeapp.springrecipeapp.domain.*;
import ramin.spring.recipeapp.springrecipeapp.repositories.CategoryRepository;
import ramin.spring.recipeapp.springrecipeapp.repositories.RecipeRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
            log.debug("Get Recipes method called in RecipeBootstrap");
